...
def test_configuration_has_database_setting():
    ...
    assert Configuration.SQLALCHEMY_DATABASE_URI == "postgresql://pyweb_practice_user:pyweb@localhost/pyweb_practice_db"


def test_sqlalchemy_database_uri_configured_properly():
    from app import app
    assert app.config.get("SQLALCHEMY_DATABASE_URI", "") == "postgresql://pyweb_practice_user:pyweb@localhost/pyweb_practice_db"
