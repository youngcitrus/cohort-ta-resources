...
// Time: O(n^2)
// // In our worst case scenario we are going to have to iterate through our array
// // n times, with each iteration having n comparisons/swaps to make.
// // (This worst case comes from an array that is in reverse order.)
// Space: O(1)
// // We are only ever creating two variables, swapped and temp, with all of our
// // checks and swapping of values happening in place.
// // Since the memory used is independent of the input size, we have constant
// // space complexity.
function bubbleSort(array) {
